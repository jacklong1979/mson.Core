...
namespace mson.Core.AuthorizationServerApi.Common
{
    /// <summary>
    /// Token中间件类
    /// </summary>
    public class TokenMiddleware
    {
        ...
        public TokenMiddleware(RequestDelegate next,IOptions<TokenOption> options)
        {
            _next = next;
        ...
        private async Task GenerateToken(HttpContext context)
        {
            ...
            var claims = new Claim[]
            {
                ...
                new Claim(JwtRegisteredClaimNames.Iat, ToUnixEpochDate(now).ToString(), ClaimValueTypes.Integer64)//发行时间
            };
